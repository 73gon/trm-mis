#!/usr/bin/env python3
"""Merge data/smallmis_n200_multi/{train_chunk_*,test_chunk_*}/mis_shard_*.pt
into data/smallmis_n200_multi/{train,test}/mis_shard_<idx>.pt with sequential
